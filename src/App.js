    ...
    return (
      <Parallax ref="parallax" pages={3}>
        ...
        >
          <div className="App">
            <div className="text">
              <img id="name" src={require("./coollogo_com-139921264.png")} alt="name" />
              <div id="subheading">
                <a href=""><h2>Fullstack JavaScript Developer</h2></a>

                <a href="https://www.linkedin.com/in/nitika-nadgar/" target="_blank" rel="noopener noreferrer"><img className="icon" src={require("./if_linkedin_2062080.svg")} alt="linkedin" /></a>
                <a href="https://medium.com/@nitikanadgar" target="_blank" rel="noopener noreferrer"><img className="icon" src={require("./if_Medium_2062081.svg")} alt="medium" /></a>
                <a href="https://www.instagram.com/nitiquita/?hl=en" target="_blank" rel="noopener noreferrer"><img className="icon" src={require("./if_Instagram_2062078.svg")} alt="instagram" /></a>
              </div>
            </div>
          </div>
        </Parallax.Layer>
        ...
        <Parallax.Layer
          offset={1}>
          <div id="skills">
            <img id="skills" src={require("./coollogo_com-14589149.png")} alt="skills" />
          </div>
          <div id="proficient">
        ...
        <Parallax.Layer
          offset={2}>
          <div id="projects">
            <img id="name" src={require("./coollogo_com-823154.png")} alt="projects" />
          </div>
          <div>
            <a href="https://github.com/Nitiquita" target="_blank" rel="noopener noreferrer"><img id="github" src={require("./if_1-06_2311228.svg")} alt="github" /></a>
          </div>
